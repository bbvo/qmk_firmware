...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------------------------------------------------------------------+
   * | Ctrl| App | Gui | Alt |  L2  |   Space   |  L1  |  /  | Left| Down |Right|
   * `-------------------------------------------------------------------------'
   */
...
LAYOUT(
  ...
  KC_LGUI, KC_APP, KC_LCTL, KC_LALT,  MO(2),      KC_SPC,        MO(1),  KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
LAYOUT( /* Left */
  ...
  _______,    KC_F8,    KC_F9,  KC_F10,  KC_F11,    KC_F12,      _______,       KC_UNDERSCORE, KC_PLUS,     KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_PIPE,
  _______,    KC_F1,    KC_F2,   KC_F3,   KC_F4,    KC_F5,      KC_F6,         KC_F7,         _______,     _______,             KC_PGUP,              _______,
  _______,   _______,  _______, KC_CAPS,   _______,    _______,            _______,       _______,     KC_HOME,             KC_PGDN,              KC_END
),
